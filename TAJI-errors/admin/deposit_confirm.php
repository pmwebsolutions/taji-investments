...
<form action="deposit_pay.php" method="post">
	
	<div class="col-lg-10">
                     <div class="card shadow mb-4">
                        <div class="card-header py-3">
						<h6 class="m-0 font-weight-bold text-primary">Deposits Made Today</h6>
						</div>
                        <div class="card-body">
						        <div class="table-responsive">
                                <table class="table table-boardered" id="dataTable" width="100%" cellspacing="0">
								<div style="float:right" >
								<a data-toggle="modal" href="#deposit_denied" id="delete"  class="btn btn-danger" name="">DENIED</a>
		...
		<?php
		$day = date('Y-m-d', time());
	$query = mysqli_query($con,"select * from deposits") or die(mysqli_error());// where created = '$day' 
	while ($row = mysqli_fetch_array($query)) {
		...
		<td><a data-toggle="modal" href="#update_wallet_deposit" id="delete"  class="btn btn-success">wallet</a></td>
								<?php include('modals.php'); ?>
