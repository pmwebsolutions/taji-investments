...
<h2>Mpesa payment(Taji)</h2>
<h4>Pay 300ksh To till number 8100616</h4>
<form action="" method="post" class="user" id="payment" onsubmit="if (!window.__cfRLUnblockHandlers) return false; return myFunction();" data-cf-modified-7b1cef93aab1c40878c2fff8-="">
<div class="form-group">

<input class="form-control form-control-user" style="text-transform:capitalize;" type="tel" name="phone" value="" placeholder="Enter M-pesa Number"  data-required="true" >
</div>
<div class="form-group">
<input class="form-control form-control-user" style="text-transform:capitalize;" type="text" name="transactionId" value="" placeholder="Enter M-pesa code i.e QWI45.."  data-required="true" >
</div>



<input class="c-input u-mb-small" type="hidden" name="username" value="codding" data-required="true" readonly>
<div class="form-group">
...
<script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="7b1cef93aab1c40878c2fff8-|49" defer=""></script></body>
