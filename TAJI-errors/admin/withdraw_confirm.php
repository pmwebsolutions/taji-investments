...
<form action="withdraw_pay.php" method="post">
	
	
	<div class="col-lg-10">
                     <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Withdrawals Made Today</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-boardered" id="dataTable" width="100%" cellspacing="0">
								<div style="float:right">
								<a data-toggle="modal" href="#withdraw_denied" id="delete"  class="btn btn-danger" name="">DENIED</a>&nbsp
		...
		<?php
		$day = date( 'Y-m-d', time());
	$query = mysqli_query($con,"select * from withdrawals") or die(mysqli_error());// where Disbursment = '$day' 
	while ($row = mysqli_fetch_array($query)) {
		$id = $row['withdraw_code'];
		?>
		...
		<td><?php echo $row['FrmAcc']; ?></td>
		<td><?php echo $row['Status']; ?></td>
		<td><?php echo $row['withdraw_code']; ?></td>
		<td width="30">
		<input id="optionsCheckbox" class="uniform_on" name="selector[]" type="checkbox" value="<?php echo $id; ?>">
		</td>
		<td><a data-toggle="modal" href="#update_wallet_withdraw" id="delete"  class="btn btn-success">wallet</a></td>
								<?php include('modals.php'); ?>
