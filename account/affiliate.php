...
<head>
    ...
    <title>Taji - Affiliate Center</title>
...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h5 mb-0 text-gray-800">Affiliate Center</h1>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Earned</div>
                                            <div class="h4 mb-0 font-weight-bold text-gray-800"> <?=count($reflist)*5?> points</div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Main Balance</div>
                                            <div class="h4 mb-0 font-weight-bold text-gray-800">KSH 40,000</div>
                                        </div>
                                        <div class="col-auto">
				...
				<div class="col-lg-6">
						...
						<div class="col-lg-6 ">
                            ...
                            <div class="card shadow mb-4">
								...
								<br>
                                <div class="card-body">
                                    <center><p class="mg-b-20">Click Copy to get your Referral Link</p></center>
                                      <input id="myInput" type="text" class="form-control form-control-user" style="color: black !important;background-color: #5053f852;" value="http://localhost/taji.or.ke/taji.or.ke/?refcode=<?=$user['user_code']?>" readonly >
											<br>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Taji Inestments 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
	...
	<script src="js/zoza.js" rel="javascript" ></script>
</body>
