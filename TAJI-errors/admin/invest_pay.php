...
<form action="update_invest.php" method="post">
	
	
	<div class="col-lg-10">
                     <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Investments Matured Today </h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-boardered" id="dataTable" width="100%" cellspacing="0">
								<div style="float:right">
								<a data-toggle="modal" href="#invest_denied" id="denied"  class="btn btn-danger" name="">DENIED</a>&nbsp
		...
		<?php
		$day = date('Y-m-d ', time());
	$query = mysqli_query($con,"select * from investments ") or die(mysqli_error());// where Maturity = '$day'
	while ($row = mysqli_fetch_array($query)) {
		$id = $row['investcode'];
		$_SESSION['value']=$row['Expectedamount'];
		...
		<td><?php echo $row['investcode']; ?></td>
		<td width="30">
		<input id="optionsCheckbox" class="uniform_on" name="selector[]" type="checkbox" value="<?php echo $id; ?>">
		</td>
		<td><a data-toggle="modal" href="#update_wallet_invest" id="delete"  class="btn btn-success">wallet</a></td>
								<?php include('modals.php'); ?>
		</tr>
	<?php } ?>    
