...
<form action="activate.php" method="post">
	...
	<div class="col-lg-10">
                     <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Activations Made Today</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-boardered" id="dataTable" width="100%" cellspacing="0">
								<div style="float:right">
								<a data-toggle="modal" href="#activ_delete" id="activate"  class="btn btn-danger" name="">DELETE</a>
		...
		<?php
		$day = date( 'Y-m-d', time());
		//$day2 = date( 'Y-m-d', strtotime('2022-11-19'));
	$query = mysqli_query($con,"select * from activation") or die(mysqli_error());// where date = '$day' 
	while ($row = mysqli_fetch_array($query)) {
		...
		<td><a data-toggle="modal" href="#useractivate" id="activate"  class="btn btn-success" name="">ACTIVATE</a></td>
				<?php include('modals.php'); ?>
		</tr>
	<?php } ?>    
