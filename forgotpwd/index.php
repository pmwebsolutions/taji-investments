...
$output.='<p>-------------------------------------------------------------</p>';
$output.='<p><a href="http://localhost/taji.or.ke/forgotpwd/reset-password.php?key='.$key.'&email='.$email.'&action=reset" target="_blank">http://localhost/taji.or.ke/forgotpwd/reset-password.php?key='.$key.'&email='.$email.'&action=reset</a></p>';		
$output.='<p>-------------------------------------------------------------</p>';
...
$output.='<p>Thanks,</p>';
$output.='<p>TAJINVESTMENTS Support Team</p>';
$body = $output; 
$subject = "Password Recovery - TAJINVESTMENTS";
...
<hr>
    ...
    <script src="http://localhost/taji.or.ke/account/vendor/jquery/jquery.min.js"></script>
    <script src="http://localhost/taji.or.ke/account/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

    <!-- Core plugin JavaScript-->
    <script src="http://localhost/taji.or.ke/account/vendor/jquery-easing/jquery.easing.min.js"></script>

    <!-- Custom scripts for all pages-->
    <script src="http://localhost/taji.or.ke/account/js/sb-admin-2.min.js"></script>
