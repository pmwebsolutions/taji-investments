...
<head>
    ...
    <title>Taji - Message Centre</title>
...
<script type="text/javascript" charset="utf-8" language="javascript" src="/sizla/Multi_Edit/js/DT_bootstrap.js"></script>
				<!--CKEDITOR-->
		<!-- wysiwug  -->
		<link rel="stylesheet" type="text/css" href="use/vendors/bootstrap-wysihtml5/src/bootstrap-wysihtml5.css"></link>
	<script src="use/vendors/ckeditor/ckeditor.js"></script>
						<!--END OF CKEDITOR-->
<?php 
include('dbcon.php');
?>
    ...
    ?>	<form method="post" class="form-horizontal">
			<div class="col-lg-10">
				<div class="card shadow mb-4">
					<div class="card-header py-3">Send Message to Users</h6>&nbsp
					<span style="float:right" class="control-group">
						<span class="controls">
							<button name="message" type="submit" class="btn btn-success">Send Message</button>
						</span>
					</span>
					</div>
						<div class="card-body">
							<div class="form-responsive">
							<div class="control-group" style="float:right">Send To: 
								<?php include('dbcon.php');
								$sql = "SELECT * FROM `users`";
									$result = mysqli_query($con, $sql);?>
								<div class="controls">
									<select  name="receiver" type="text" class="form-control c-input u-mb-small" required>';
							...
							<div class="control-group">Subject
									<div class="controls">
										<input type="text"  size="35" name="subject" id="Subject" placeholder="Subject">
									</div>
							</div>
								&nbsp							
								<div class="control-group">
										<label class="control-label" for="ckeditor_full">Content</label>
									<div class="controls">
										<textarea class="ckeditor" name="comment" id="ckeditor_full">
