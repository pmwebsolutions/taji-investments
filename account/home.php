                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a data-toggle="collapse" data-target="#alertsDropdown" class="dropdown-item text-center small text-gray-500" >Show All Alerts</a>
                            </div>
                        </li>
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <!-- Dropdown - Messages -->
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                aria-labelledby="messagesDropdown" id="messageDropdown" data-toggle="dropdown">
                                <h6 class="dropdown-header">
                                    Message Center
                                </h6>
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                ...
                                <a class="dropdown-item text-center small text-gray-500" data-target="#messageDropdown" role="button">Read More Messages</a>
                            </div>
                        </li>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <p class="mg-b-20">Click Copy to get your Referral Link</p>
                                      <input id="myInput" type="text" class="form-control form-control-user" style="color: black !important;background-color: #5053f852;" value="http://localhost/taji.or.ke/?refcode=<?=$user['user_code']?>" readonly >
											<br>
